...
def DesignMatrix(Options):
    ...
    for File in Files:
        ...
        L.append(str(File).split("/")[1].split("\\")[1])
        print(str(File).split("/")[1].split("\\")[1])
...
def Image2Vector(File):
    ...
    FID = face_recognition.load_image_file(
        "temp.jpg")  # carga de imagen reescalada
...
Options.SPath = "files/TC3002B_Faces/"
